...
Source file (unpublished Copy): `4Q2KGg9fstrN2BWCwYChzi`

跨文件导入 APP 语义色用已发布团队库「信用卡基础组件」的 APP collection（`0c545bbeafd3546a22b5849ced26ece279a1ee3b`）。Copy 里的 variable key 未发布，`importVariableByKeyAsync` 会失败。
